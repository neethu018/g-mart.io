      ...
      <Row>
        <Col md={6} sm={12} lg={6}>
          <div
            ...
            // style={{ marginLeft: "50px",backgroundColor:"red" }}
          >
            <Carousel
              style={{
                maxWidth: "500px",
              ...
              {product.productImage.map((image, index) => (
                <Carousel.Item key={index}>
                  <Image
                    ...
                    style={{
                      objectFit: "cover", // Maintain aspect ratio while covering the whole area
                      maxHeight: "400px", // You can adjust the max height if needed
                      borderRadius: "20px",
                    }}
                  />
                </Carousel.Item>
        ...
        {/* right column */}
        <Col
          className="scrollable-no-scrollbar mt-3"
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <div style={{ display: "flex" }}>
              ...
              <FontAwesomeIcon icon={faStar} color="gold" />
              <FontAwesomeIcon icon={faStar} color="gold" />
              <p style={{ marginLeft: "10px", paddingLeft: "5px" }}>
                {product.ratings}
              </p>
            </div>
            <div>
          ...
          <div>
            ...
            <div>
              ...
              <div>
                <h2>
                  <strong>Offers (20)</strong>
                </h2>
                <div style={{ display: "flex" }}>
                  <FontAwesomeIcon icon={faGift} color="green" />
                  <h6 style={{ fontWeight: "bold", paddingLeft: "5px" }}>
                    ADDITIONAL OFFER
                  </h6>
                </div>
                <p style={{ color: "grey", fontWeight: "bold" }}>
                  {product.additionalOffers}
                </p>
                <div style={{ display: "flex" }}>
          ...
          <div>
            ...
            <p style={{ color: "grey", fontWeight: "bold" }}>30-07-2024</p>
            <h5>
              <strong>Brand:</strong>
            </h5>
            <p style={{ color: "grey", fontWeight: "bold" }}>{product.brand}</p>
            <h5>
