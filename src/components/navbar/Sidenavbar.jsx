            ...
            <div className="header">
              ...
              <div className="sign">
                {currentUser ? (
                  <Link to="/">
                    {" "}
                    <button className="btn second" onClick={logoutUser}>
                      Logout
                    </button>
                  </Link>
                ) : (
                ...
                <ul className="nav-section-list" onClick={showsidebar}>
                  <li className="nav-section-list-item divider-h">
                    <Link className="d" to="/">
                      <img
                        className="icon jm"
                        src="https://img.icons8.com/external-inkubators-glyph-inkubators/25/0078ad/external-home-ecommerce-user-interface-inkubators-glyph-inkubators.png"
                        alt="home"
                      />
                  ...
                  <li className="nav-section-list-item divider-h">
                    <Link className="d" to="/allcategory">
                      <img
                        ...
                        width="24"
                        height="24"
                        src="https://img.icons8.com/sf-black/64/0078ad/bulleted-list.png"
                        alt="bulleted-list"
                      />
                  ...
                  <li className="nav-section-list-item divider-h">
                    <Link className="d" to="/cart">
                      <img
                        ...
                        width={24}
                        height={24}
                        src="https://img.icons8.com/external-flat-icons-inmotus-design/67/0078ad/external-box-box-flat-icons-inmotus-design-3.png"
                        alt="external-box-box-flat-icons-inmotus-design-3"
                      />
                      <span className="nav-section-list-title word">
                        My Orders
                      </span>
                  ...
                  <li className="nav-section-list-item divider-h">
                    <Link className="d" to="/wishlist">
                      <img
                        ...
                        width={24}
                        height={24}
                        src="https://img.icons8.com/ios-filled/50/0078ad/like--v1.png"
                        alt="like--v1"
                      />
                      <span className="nav-section-list-title word">
                        Wishlist
                  ...
                  <li className="nav-section-list-item divider-h">
                    <Link className="d" to="/faq">
                      <img
                        ...
                        width={24}
                        height={24}
                        src="https://img.icons8.com/ios-filled/50/0078ad/ask-question.png"
                        alt="ask-question"
                      />
                      <span className="nav-section-list-title word">
                        FAQs/Need Help
                  ...
                  <li className="nav-section-list-item divider-h">
                    <Link className="d" to="/about">
                      <img
                        ...
                        title="about"
                        height={24}
                        src="https://img.icons8.com/sf-black-filled/64/0078ad/conference-call.png"
                        alt="conference-call"
                      />
                      <span className="nav-section-list-title word">
                        About Us
                  ...
                  <li className="nav-section-list-item divider-h">
                    <Link className="d" to="/contact-us">
                      <img
                        ...
                        width={24}
                        height={24}
                        src="https://img.icons8.com/ios-filled/50/0078ad/phone-message.png"
                        alt="phone-message"
                      />
                      <span className="nav-section-list-title word">
                        Contact Us
                  ...
                  <li className="nav-section-list-item divider-h">
                    <Link className="d" to="/guide">
                      <img
                        ...
                        width={24}
                        height={24}
                        src="https://img.icons8.com/ios-filled/50/0078ad/compass--v1.png"
                        alt="compass--v1"
                      />
            ...
            <div className="bottom-section">
              ...
              <div className="info-section text">
                <div className="info-section-item">
                  ...
                  problems on the website, please email us on
                  <a
                    className="text-link"
                    href="mailto:cs@jiomart.com"
                    onClick={showsidebar}
                  >
                    cd@gmart.com
                  </a>
